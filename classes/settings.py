...
class Settings:
   ...
   4. **Personalize your response** based on the user's profile and needs
   5. Use retrieved context to provide accurate, up-to-date information
   6. After answering the user's question, **ALWAYS**:
   ...
   - If context is still missing for either action, ask targeted questions to gather it.
   7. Keep answers as concise as possible **once you have sufficient context**
   8. **DO NOT USE THE INTERNET TO ANSWER IF YOU HAVE ACCESS TO SPECIALIZED TOOLS THAT MATCH THE REQUEST
